...
import numberSchema from './auth/middlewares/numberValidation';
...
app.get('/', (req: Request, res: Response) => {
    res.send('<br/> Read docs from here: <a href="http://localhost:1337/docs">Swagger</a>');
});
...
app.post('/rooms', validate(numberSchema), roomsController.createRoom);
